...
local function GetTierColor(NumMPS)
    ...
    elseif NumMPS >= 600000000 then
        return Color3.fromRGB(255, 165, 0)   -- Orange for 600M–999M
    elseif NumMPS >= 400000000 then
        return Color3.fromRGB(255, 255, 0)   -- Yellow for 400M–599M
    elseif NumMPS >= 200000000 then
        return Color3.fromRGB(0, 255, 255)   -- Cyan for 200M–399M
